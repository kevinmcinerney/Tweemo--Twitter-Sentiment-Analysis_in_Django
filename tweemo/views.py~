...
def pull_tweets(q):
	...
	for time in time_list:
		for country in country_dictionary:
			...
			for tweet in searched_tweets:
				ascii_tweet = convert_unicode_to_string(tweet)
				temp_tweet = WordPunctTokenizer().tokenize(ascii_tweet)	
	...
	data_list = [[data_count],[data_strength],[c_score],[master_samples],[tweet_words_dic]]	
...
def create_dictData6(data):
    ...
    dictData6.append(['Words', 'Frequency'])
