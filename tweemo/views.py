...
def results(request):
    ...
    trends = "<iframe style=''src='http://www.google.com/trends/fetchComponent?q=mary,bob&cid=TIMESERIES_GRAPH_0&export=5' id=\"frame\" name=\"info2\" width=\"985px\" height=\"350px\" seamless=\"\"></iframe>"
